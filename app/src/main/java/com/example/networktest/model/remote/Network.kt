 ...
 * fun [TARGET FUNCTION].funcName(args: Any) {Unit}
 */
...
fun executeBookSearch(bookTitle: String): BookResponse {
    ...
    // TODO Convert InputStream to String
    ...
    Log.d(TAG, "executeBookSearch: IS = ${bookResponseString} RC = $bookResponseCode")
    return convertionToPresentationdata(bookResponseString)
}

private fun convertionToPresentationdata(deSerialized: String): BookResponse{
...
//private fun convertToPresentationData(deserialized: String){
//
//}
